...
const updateUserVerifiationStatus = `-- name: UpdateUserVerifiationStatus :exec
...
func (q *Queries) UpdateUserVerifiationStatus(ctx context.Context, verifyKeyHash string) error {
	_, err := q.db.ExecContext(ctx, updateUserVerifiationStatus, verifyKeyHash)
	return err
}
